...
void Intro()
{
  ...
  PrintCentre("Hobby Components", 1, (ResY / 2) - 32);
  PrintCentre("HCDisplay", 2,  (ResY / 2) - 18);
  PrintCentre("Library Demo", 1,  (ResY / 2) + 6);

  HCDisplay.SetFont(LCDLarge_24ptFont);
  
  for(int8_t i = 10; i >= 0; i--)
  {
    HCDisplay.Erase(ResX / 2, 80, ResX / 2 + 40, 110);
    HCDisplay.Pos(ResX / 2, 80);
    HCDisplay.Print(i, 0);
    delay(1000);
  }
