...
/* Display resolution */
#define BUFFERCOLSIZE 84
#define BUFFERBYTEROWSIZE 6

#define RES_X 84	//Screen X axis resolution
#define RES_Y 48	//Screen Y axis resolution
...
class Display
{
	public:
		Display(void);
		void DInit(uint8_t din, uint8_t clk, uint8_t rst, uint8_t ce, uint8_t dc, uint8_t bl = 255);
